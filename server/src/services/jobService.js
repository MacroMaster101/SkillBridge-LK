...
// ---------------------------------------------------------------------------
// Candidate-side: skill-matched job listing (Feature 3)
// ---------------------------------------------------------------------------
...
export async function listJobs(filters, candidateId) {
  ...
  // company/title/category search (post-filter, company lives on the joined table)
  if (filters.q) {
...
// ---------------------------------------------------------------------------
// Public browsing + employer-side (job posting)
// ---------------------------------------------------------------------------
import { supabase } from '../config/supabase.js';
import { AppError } from '../utils/errors.js';
import { getEmployerByOwnerId } from '../utils/employerAuth.js';
...
/* --- Candidate-facing listing: jobs scored against one candidate's skills --- */
